...
class List(AAZCommand):
    ...
    :example: ResourceTypeRegistrations_ListByProviderRegistration
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.ResourceTypeRegistrationsListByProviderRegistration(ctx=self.ctx)()
    ...
    class ResourceTypeRegistrationsListByProviderRegistration(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            allowed_resource_names = cls._schema_on_200.value.Element.properties.allowed_resource_names
            allowed_resource_names.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.allowed_resource_names.Element
            _element.get_action_verb = AAZStrType(
                serialized_name="getActionVerb",
            )
            _element.name = AAZStrType()

            allowed_template_deployment_reference_actions = cls._schema_on_200.value.Element.properties.allowed_template_deployment_reference_actions
            allowed_template_deployment_reference_actions.Element = AAZStrType()

            allowed_unauthorized_actions = cls._schema_on_200.value.Element.properties.allowed_unauthorized_actions
            allowed_unauthorized_actions.Element = AAZStrType()

            allowed_unauthorized_actions_extensions = cls._schema_on_200.value.Element.properties.allowed_unauthorized_actions_extensions
            allowed_unauthorized_actions_extensions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.allowed_unauthorized_actions_extensions.Element
            _element.action = AAZStrType()
            _element.intent = AAZStrType()

            api_profiles = cls._schema_on_200.value.Element.properties.api_profiles
            api_profiles.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.api_profiles.Element
            ...
            async_timeout_rules = cls._schema_on_200.value.Element.properties.async_timeout_rules
            async_timeout_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.async_timeout_rules.Element
            _element.action_name = AAZStrType(
                serialized_name="actionName",
            )
            _element.timeout = AAZStrType()

            authorization_action_mappings = cls._schema_on_200.value.Element.properties.authorization_action_mappings
            authorization_action_mappings.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.authorization_action_mappings.Element
            _element.desired = AAZStrType()
            _element.original = AAZStrType()

            availability_zone_rule = cls._schema_on_200.value.Element.properties.availability_zone_rule
            availability_zone_rule.availability_zone_policy = AAZStrType(
                serialized_name="availabilityZonePolicy",
            )

            capacity_rule = cls._schema_on_200.value.Element.properties.capacity_rule
            ...
            check_name_availability_specifications = cls._schema_on_200.value.Element.properties.check_name_availability_specifications
            ...
            resource_types_with_custom_validation = cls._schema_on_200.value.Element.properties.check_name_availability_specifications.resource_types_with_custom_validation
            resource_types_with_custom_validation.Element = AAZStrType()

            common_api_versions = cls._schema_on_200.value.Element.properties.common_api_versions
            common_api_versions.Element = AAZStrType()

            disallowed_action_verbs = cls._schema_on_200.value.Element.properties.disallowed_action_verbs
            disallowed_action_verbs.Element = AAZStrType()

            disallowed_end_user_operations = cls._schema_on_200.value.Element.properties.disallowed_end_user_operations
            ...
            api_versions = cls._schema_on_200.value.Element.properties.endpoints.Element.api_versions
            api_versions.Element = AAZStrType()

            dsts_configuration = cls._schema_on_200.value.Element.properties.endpoints.Element.dsts_configuration
            dsts_configuration.service_dns_name = AAZStrType(
                serialized_name="serviceDnsName",
            )
            dsts_configuration.service_name = AAZStrType(
            ...
            extensions = cls._schema_on_200.value.Element.properties.endpoints.Element.extensions
            extensions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.endpoints.Element.extensions.Element
            _element.endpoint_uri = AAZStrType(
                serialized_name="endpointUri",
            )
            ...
            extension_categories = cls._schema_on_200.value.Element.properties.endpoints.Element.extensions.Element.extension_categories
            extension_categories.Element = AAZStrType()

            features_rule = cls._schema_on_200.value.Element.properties.endpoints.Element.features_rule
            features_rule.required_features_policy = AAZStrType(
                serialized_name="requiredFeaturesPolicy",
                flags={"required": True},
            )

            locations = cls._schema_on_200.value.Element.properties.endpoints.Element.locations
            locations.Element = AAZStrType()

            required_features = cls._schema_on_200.value.Element.properties.endpoints.Element.required_features
            required_features.Element = AAZStrType()

            zones = cls._schema_on_200.value.Element.properties.endpoints.Element.zones
            zones.Element = AAZStrType()

            extended_locations = cls._schema_on_200.value.Element.properties.extended_locations
            extended_locations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.extended_locations.Element
            _element.supported_policy = AAZStrType(
                serialized_name="supportedPolicy",
            )
            _element.type = AAZStrType()

            extension_options = cls._schema_on_200.value.Element.properties.extension_options
            extension_options.resource_creation_begin = AAZObjectType(
                serialized_name="resourceCreationBegin",
            )

            resource_creation_begin = cls._schema_on_200.value.Element.properties.extension_options.resource_creation_begin
            resource_creation_begin.request = AAZListType()
            resource_creation_begin.response = AAZListType()

            request = cls._schema_on_200.value.Element.properties.extension_options.resource_creation_begin.request
            request.Element = AAZStrType()

            response = cls._schema_on_200.value.Element.properties.extension_options.resource_creation_begin.response
            ...
            identity_management = cls._schema_on_200.value.Element.properties.identity_management
            ...
            application_ids = cls._schema_on_200.value.Element.properties.identity_management.application_ids
            application_ids.Element = AAZStrType()

            delegation_app_ids = cls._schema_on_200.value.Element.properties.identity_management.delegation_app_ids
            delegation_app_ids.Element = AAZStrType()

            legacy_names = cls._schema_on_200.value.Element.properties.legacy_names
            legacy_names.Element = AAZStrType()

            legacy_policy = cls._schema_on_200.value.Element.properties.legacy_policy
            ...
            disallowed_conditions = cls._schema_on_200.value.Element.properties.legacy_policy.disallowed_conditions
            disallowed_conditions.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.legacy_policy.disallowed_conditions.Element
            _element.disallowed_legacy_operations = AAZListType(
                serialized_name="disallowedLegacyOperations",
            )
            _element.feature = AAZStrType()

            disallowed_legacy_operations = cls._schema_on_200.value.Element.properties.legacy_policy.disallowed_conditions.Element.disallowed_legacy_operations
            disallowed_legacy_operations.Element = AAZStrType()

            disallowed_legacy_operations = cls._schema_on_200.value.Element.properties.legacy_policy.disallowed_legacy_operations
            disallowed_legacy_operations.Element = AAZStrType()
            ...
            linked_access_checks = cls._schema_on_200.value.Element.properties.linked_access_checks
            linked_access_checks.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.linked_access_checks.Element
            _element.action_name = AAZStrType(
                serialized_name="actionName",
            )
            ...
            actions_on_failed_operation = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.actions_on_failed_operation
            actions_on_failed_operation.Element = AAZStrType()

            fast_path_actions = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.fast_path_actions
            fast_path_actions.Element = AAZStrType()

            fast_path_actions_on_failed_operation = cls._schema_on_200.value.Element.properties.linked_notification_rules.Element.fast_path_actions_on_failed_operation
            fast_path_actions_on_failed_operation.Element = AAZStrType()

            linked_operation_rules = cls._schema_on_200.value.Element.properties.linked_operation_rules
            linked_operation_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.linked_operation_rules.Element
            ...
            depends_on_types = cls._schema_on_200.value.Element.properties.linked_operation_rules.Element.depends_on_types
            depends_on_types.Element = AAZStrType()

            logging_rules = cls._schema_on_200.value.Element.properties.logging_rules
            logging_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.logging_rules.Element
            _element.action = AAZStrType(
                flags={"required": True},
            )
            ...
            hidden_property_paths = cls._schema_on_200.value.Element.properties.logging_rules.Element.hidden_property_paths
            ...
            hidden_paths_on_request = cls._schema_on_200.value.Element.properties.logging_rules.Element.hidden_property_paths.hidden_paths_on_request
            hidden_paths_on_request.Element = AAZStrType()

            hidden_paths_on_response = cls._schema_on_200.value.Element.properties.logging_rules.Element.hidden_property_paths.hidden_paths_on_response
            ...
            application_ids = cls._schema_on_200.value.Element.properties.managed_resource_group_configuration.application_ids
            application_ids.Element = AAZStrType()

            deny_assignment_configuration = cls._schema_on_200.value.Element.properties.managed_resource_group_configuration.deny_assignment_configuration
            ...
            not_actions = cls._schema_on_200.value.Element.properties.managed_resource_group_configuration.deny_assignment_configuration.not_actions
            ...
            marketplace_options = cls._schema_on_200.value.Element.properties.marketplace_options
            ...
            _element = cls._schema_on_200.value.Element.properties.metadata.Element
            ...
            on_behalf_of_tokens = cls._schema_on_200.value.Element.properties.on_behalf_of_tokens
            ...
            open_api_configuration = cls._schema_on_200.value.Element.properties.open_api_configuration
            open_api_configuration.validation = AAZObjectType()

            validation = cls._schema_on_200.value.Element.properties.open_api_configuration.validation
            validation.allow_noncompliant_collection_response = AAZBoolType(
                serialized_name="allowNoncompliantCollectionResponse",
            )

            private_endpoint_configuration = cls._schema_on_200.value.Element.properties.private_endpoint_configuration
            ...
            group_connectivity_information = cls._schema_on_200.value.Element.properties.private_endpoint_configuration.group_connectivity_information
            group_connectivity_information.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.private_endpoint_configuration.group_connectivity_information.Element
            ...
            required_members = cls._schema_on_200.value.Element.properties.private_endpoint_configuration.group_connectivity_information.Element.required_members
            required_members.Element = AAZStrType()

            required_zone_names = cls._schema_on_200.value.Element.properties.private_endpoint_configuration.group_connectivity_information.Element.required_zone_names
            required_zone_names.Element = AAZStrType()

            quota_rule = cls._schema_on_200.value.Element.properties.quota_rule
            ...
            location_rules = cls._schema_on_200.value.Element.properties.quota_rule.location_rules
            location_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.quota_rule.location_rules.Element
            ...
            required_features = cls._schema_on_200.value.Element.properties.quota_rule.required_features
            required_features.Element = AAZStrType()
            ...
            resource_cache = cls._schema_on_200.value.Element.properties.resource_cache
            ...
            resource_concurrency_control_options = cls._schema_on_200.value.Element.properties.resource_concurrency_control_options
            resource_concurrency_control_options.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_concurrency_control_options.Element
            _element.policy = AAZStrType()

            resource_deletion_policies = cls._schema_on_200.value.Element.properties.resource_deletion_policies
            resource_deletion_policies.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_deletion_policies.Element
            _element.policy_name = AAZStrType(
                serialized_name="policyName",
            )
            _element.properties = AAZObjectType()

            properties = cls._schema_on_200.value.Element.properties.resource_deletion_policies.Element.properties
            ...
            resource_graph_configuration = cls._schema_on_200.value.Element.properties.resource_graph_configuration
            resource_graph_configuration.api_version = AAZStrType(
                serialized_name="apiVersion",
            )
            resource_graph_configuration.enabled = AAZBoolType()

            resource_management_options = cls._schema_on_200.value.Element.properties.resource_management_options
            ...
            batch_provisioning_support = cls._schema_on_200.value.Element.properties.resource_management_options.batch_provisioning_support
            ...
            action_configurations = cls._schema_on_200.value.Element.properties.resource_management_options.batch_provisioning_support.action_configurations
            action_configurations.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_management_options.batch_provisioning_support.action_configurations.Element
            ...
            required_features = cls._schema_on_200.value.Element.properties.resource_management_options.batch_provisioning_support.required_features
            required_features.Element = AAZStrType()

            delete_dependencies = cls._schema_on_200.value.Element.properties.resource_management_options.delete_dependencies
            delete_dependencies.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.resource_management_options.delete_dependencies.Element
            _element.linked_property = AAZStrType(
                serialized_name="linkedProperty",
            )
            _element.linked_type = AAZStrType(
            ...
            required_features = cls._schema_on_200.value.Element.properties.resource_management_options.delete_dependencies.Element.required_features
            required_features.Element = AAZStrType()

            nested_provisioning_support = cls._schema_on_200.value.Element.properties.resource_management_options.nested_provisioning_support
            nested_provisioning_support.minimum_api_version = AAZStrType(
                serialized_name="minimumApiVersion",
            )

            resource_move_policy = cls._schema_on_200.value.Element.properties.resource_move_policy
            ...
            resource_query_management = cls._schema_on_200.value.Element.properties.resource_query_management
            resource_query_management.filter_option = AAZStrType(
                serialized_name="filterOption",
            )

            resource_type_common_attribute_management = cls._schema_on_200.value.Element.properties.resource_type_common_attribute_management
            ...
            routing_rule = cls._schema_on_200.value.Element.properties.routing_rule
            routing_rule.host_resource_type = AAZStrType(
                serialized_name="hostResourceType",
            )

            service_tree_infos = cls._schema_on_200.value.Element.properties.service_tree_infos
            service_tree_infos.Element = AAZObjectType()
            _ListHelper._build_schema_service_tree_info_read(service_tree_infos.Element)
            ...
            subscription_state_rules = cls._schema_on_200.value.Element.properties.subscription_state_rules
            subscription_state_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.subscription_state_rules.Element
            _element.allowed_actions = AAZListType(
                serialized_name="allowedActions",
            )
            _element.state = AAZStrType()

            allowed_actions = cls._schema_on_200.value.Element.properties.subscription_state_rules.Element.allowed_actions
            allowed_actions.Element = AAZStrType()

            swagger_specifications = cls._schema_on_200.value.Element.properties.swagger_specifications
            swagger_specifications.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.swagger_specifications.Element
            _element.api_versions = AAZListType(
                serialized_name="apiVersions",
            )
            ...
            api_versions = cls._schema_on_200.value.Element.properties.swagger_specifications.Element.api_versions
            api_versions.Element = AAZStrType()

            lifecycle_info = cls._schema_on_200.value.Element.properties.swagger_specifications.Element.lifecycle_info
            lifecycle_info.lifecycle_stage = AAZStrType(
                serialized_name="lifecycleStage",
            )
            ...
            template_deployment_policy = cls._schema_on_200.value.Element.properties.template_deployment_policy
            ...
            throttling_rules = cls._schema_on_200.value.Element.properties.throttling_rules
            throttling_rules.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.throttling_rules.Element
            _element.action = AAZStrType(
                flags={"required": True},
            )
            ...
            application_id = cls._schema_on_200.value.Element.properties.throttling_rules.Element.application_id
            application_id.Element = AAZStrType()

            metrics = cls._schema_on_200.value.Element.properties.throttling_rules.Element.metrics
            metrics.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.throttling_rules.Element.metrics.Element
            ...
            required_features = cls._schema_on_200.value.Element.properties.throttling_rules.Element.required_features
            required_features.Element = AAZStrType()

            write_lock = cls._schema_on_200.value.Element.properties.write_lock
