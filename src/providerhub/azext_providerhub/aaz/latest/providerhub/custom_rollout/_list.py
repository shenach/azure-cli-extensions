...
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.CustomRolloutsListByProviderRegistration(ctx=self.ctx)()
    ...
    class CustomRolloutsListByProviderRegistration(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            completed_regions_info = cls._schema_on_200.value.Element.properties.status.completed_regions_info
            completed_regions_info.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.status.completed_regions_info.Element
