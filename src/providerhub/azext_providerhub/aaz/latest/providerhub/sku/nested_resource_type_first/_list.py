...
@register_command(
    "providerhub sku nested-resource-type-first list",
)
class List(AAZCommand):
    """List the list of skus for the given resource type.

    :example: Skus_ListByResourceTypeRegistrationsNestedResourceTypeFirst
    ...
    _aaz_info = {
        ...
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/providers/microsoft.providerhub/providerregistrations/{}/resourcetyperegistrations/{}/resourcetyperegistrations/{}/skus", "2026-02-01-preview"],
        ]
    }
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SkusListByResourceTypeRegistrationsNestedResourceTypeFirst(ctx=self.ctx)()
